...
<body>
	...
	<div class="wrapper">
		...
		<form th:action="/forgotpassword" method="post">
			...
			<div class="field">
				<input type="number" , name="userid" required> <label>UserId</label>
			</div>
			<div class="field">
				<input type="text" , name="newpassword" required> <label>New
					Password</label>
			</div>
			<div class="field">
				<input type="password" name="cnfpassword" required> <label>Confirmed
					Password</label>
			</div>
			<div class="field">
				<input type="submit" value="Confirm">
			</div>
			<c:if test="${not empty forgeterror}">
				<p style="color: red">${forgeterror}</p>
			</c:if>
		</form>
	</div>
