		...
		<div class="sidebar pe-4 pb-3">
			<nav class="navbar bg-light navbar-light">
				...
				<div class="navbar-nav w-100">
					<a href="/supportDashboard" class="nav-item nav-link "><i
						class="fa fa-tachometer-alt me-2"></i>Pending Issues</a> <a
						href="/supportResolvedIssues" class="nav-item nav-link active"><i
					...
					<div class="col-sm-6 col-xl-4">
						<div
							...
							<div class="ms-3">
								...
								<% Integer pendingIssues = (Integer) request.getAttribute("supPendingIssues") ;
                                System.out.println("");%>
					...
					<div class="col-sm-6 col-xl-4">
						<div
							...
							<div class="ms-3">
								...
								<% Integer resolvedIssues = (Integer) request.getAttribute("supResolvedIssues") ;
                                 System.out.println("Resolved table hit");%>
						...
						<div class="table-responsive"
							...
							<table
								...
								<tbody>
									...
									<%
										List<Tickets> itemList = (List<Tickets>) request.getAttribute("resolvedissues");
										for (Tickets item : itemList) {
									%>
									<tr>
										<%System.out.println("Ticket Id " + item.getTicketId()); %>
