...
<body>
			...
			<nav class="navbar bg-light navbar-light">
				...
				<div class="navbar-nav w-100">
					<a href="/supportDashboard" class="nav-item nav-link active"><i
						...
						href="/supportResolvedIssues" class="nav-item nav-link"><i
									...
									<td>
										...
										<form action="/getMessage" method="post">
											<input type="hidden" name="buttonId"
												...
												class="btn btn-sm btn-success"> <input type="submit"
												name="choice" value="Reject" class="btn btn-sm btn-danger">
										</form>
									</td>
								</tr>
								<%
	...
	<div id="feedbackPopup" style="display: none;" class="popup">
		<!-- <h3>Feedback Form</h3> -->
		<form id="feedbackForm">
			<textarea id="feedbackMessage" placeholder="Your feedback here"
			...
			function openPopup(action) {
				...
				/* // Close the popup when clicking outside of it
				   document.addEventListener('click', function(event) {
				       if (!popup.contains(event.target) && event.target !== document.getElementById('approveButton') && event.target !== document.getElementById('rejectButton')) {
